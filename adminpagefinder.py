...
init()
print(pyfiglet.figlet_format('Admin Finder'))

post = ['admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
print("*" *69)
print("* Youtube: https://www.youtube.com/channel/UC0TtU5r0X94cLkIL6FlDUPQ *")
print("* WebSite : ""https://7hamyar.ir                                      *") 
print("* Developers : " "mehdi ghezelbash                                     *")
print("* --help > ENTER URL > Example : google.com                         *")
print("*" *69)
...
init()
for num in post:
    nume2 = requests.get("https://"+url+"/"+num)
    if nume2.status_code == 200:
        print(Fore.GREEN+" [+] " + "Page Found "+Fore.WHITE+"https://"+url+"/"+num)
    else:
        print(Fore.RED+" [-] " + "Not Found "+Fore.WHITE+"https://"+url+"/"+num)
